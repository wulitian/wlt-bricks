(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.wltComponents = {}, global.Vue));
  ...
  const imageStylePropsNames = without$1(Object.keys(imageDefaultProps), 'actionType', 'url', 'src');
  const shapeStylePropsNames = without$1(Object.keys(imageDefaultProps), 'actionType', 'url');
  ...
  const useComponentCommon = (props, picks) => {
      const styleProps = vue.computed(() => pick$1(props, picks));
      const handleClick = () => {
